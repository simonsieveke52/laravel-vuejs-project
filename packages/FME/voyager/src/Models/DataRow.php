...
class DataRow extends Model
{
     ...
     * @return Stdclass
     */
    public function getDisplayOptionsAttribute()
    {
        $details = $this->getDetailsAttribute($this->attributes['details']);
        $display = $details->display ?? new \Stdclass;
     ...
     * @return Stdclass
     */
    public function getDisplayCrudOptionsAttribute()
    {
        $details = $this->getDetailsAttribute($this->attributes['details']);
        $crud = $details->crud ?? new \Stdclass;
