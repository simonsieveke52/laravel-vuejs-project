...
class VoyagerServiceProvider extends ServiceProvider
{
    ...
    public function boot(Router $router, Dispatcher $event)
    {
        ...
        Route::bind('any_product', function ($id) {
            return \App\Product::withoutGlobalScopes()->findOrFail($id);
        });
    }
    ...
    private function registerPublishableResources()
    {
        ...
        $publishable = [
            'voyager_webfonts' => [
                "{$publishablePath}/assets/webfonts/" => public_path('webfonts'),
            ],
            'voyager_assets' => [
                "{$publishablePath}/assets/" => public_path('admin'),
            ],
            'voyager_avatar' => [
