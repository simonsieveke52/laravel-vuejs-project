...
<div class="row row-dd row-dd-relationship">
    <div class="col">
        <h4><strong>{{ $relationship->getTranslatedAttribute('display_name') }}</strong></h4>
        ...
        <div class="d-flex flex-row">
            ...
            <div class="d-flex flex-column justify-content-start mr-3">
                ...
                <label for="field_browse_{{ $relationship['field'] }}"> 
                    <input 
                        type="checkbox" 
                        name="field_browse_{{ $relationship['field'] }}" 
                ...
                <label for="field_read_{{ $relationship['field'] }}"> 
                    <input 
                        type="checkbox" 
                        name="field_read_{{ $relationship['field'] }}" 
            ...
            <div class="d-flex flex-column justify-content-start">
                ...
                <label for="field_edit_{{ $relationship['field'] }}"> 
                    <input 
                        type="checkbox" 
                        name="field_edit_{{ $relationship['field'] }}" 
                ...
                <label for="field_add_{{ $relationship['field'] }}"> 
                    <input 
                        type="checkbox" 
                        name="field_add_{{ $relationship['field'] }}" 
                ...
                <label class="d-none" for="field_delete_{{ $relationship['field'] }}"> 
                    <input 
                        type="checkbox" 
                        name="field_delete_{{ $relationship['field'] }}" 
    ...
    <div class="col-md-12 voyager-relationship-details">
        ...
        <div class="relationship_details_content">
            ...
            <div class="relationshipField">
                ...
                <div class="relationship_details_content margin_top hasOneMany @if(isset($relationshipDetails->type) && in_array($relationshipDetails->type, ['hasOne', 'hasMany'])) flexed @endif">
        ...
        <div class="relationship_details_content margin_top">
            ...
            <label class="relationship_key" style="@if(isset($relationshipDetails->type) && in_array($relationshipDetails->type, ['belongsTo', 'belongsToMany'])) display:block @endif">{{ __('voyager::database.relationship.store_the') }} <span class="label_table_name"></span></label>
            <select name="relationship_key_{{ $relationship['field'] }}" class="rowDrop select2 relationship_key" 
                style="@if(isset($relationshipDetails->type) && in_array($relationshipDetails->type, ['belongsTo', 'belongsToMany'])) display:block @endif" data-table="@if(isset($relationshipDetails->table)){{ $relationshipDetails->table }}@endif" data-selected="@if(isset($relationshipDetails->key)){{ $relationshipDetails->key }}@endif">
