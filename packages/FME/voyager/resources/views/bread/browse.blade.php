                    ...
                    <div class="btn-group rounded-lg align-items-center">
                        ...
                        @can('edit', app($dataType->model_name))
                            ...
                            @if(isset($dataType->order_column) && isset($dataType->order_display_column))
                                <a href="{{ route('voyager.'.$dataType->slug.'.order') }}" class="btn btn-default btn-add-new btn-sm">
                        ...
                        @can('delete', app($dataType->model_name))
                            @if($usesSoftDeletes)
                                <input 
                                    type="checkbox" 
                                    @if ($showSoftDeleted) checked @endif 
                                    id="show_soft_deletes" 
                                    data-height="26.5"
                                    data-width="200"
                                    data-toggle="toggle" 
                                    data-size="xs"
            ...
            <div class="col-12">
                ...
                <div class="col-12 page-content browse">
                    ...
                    <div class="row">
                        <div class="col-12">
                            @if ($isServerSide)
                                <form class="p-3 bg-light rounded-lg mb-3" method="get" class="form-search">
                                    <div class="d-flex align-items-center flex-row" id="search-input">
                                        <div class="mr-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive @if (! $isServerSide) row @endif">
