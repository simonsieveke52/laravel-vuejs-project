...
<div>
    ...
    <div id="toolbar" v-if="showToolbar" :style="expanded ? 'display:block' : 'display:none'">
        <div class="btn-group">
            <button type="button" class="btn btn-pink" id="upload" v-if="allowUpload">
                <i class="voyager-upload"></i>
                {{ __('voyager::generic.upload') }}
            </button>
            <button type="button" class="btn btn-pink" v-if="allowCreateFolder" data-toggle="modal" :data-target="'#create_dir_modal_'+this._uid">
    ...
    <div id="content" :style="expanded ? 'display:block' : 'display:none'">
        <div class="breadcrumb-container">
            <ol class="breadcrumb mb-0 filemanager align-items-center flex-row">
                <li class="media_breadcrumb cursor-pointer" v-on:click="setCurrentPath(-1)">
                    <strong>{{ __('voyager::media.library') }}</strong>
                </li>
                <li v-for="(folder, i) in getCurrentPath()" v-on:click="setCurrentPath(i)" class="d-flex align-items-center cursor-pointer">
                    &nbsp;&nbsp;>&nbsp;&nbsp;@{{ folder }}
                </li>
            </ol>
        </div>
        <div class="flex">
            <div id="left">
                ...
                <div id="no_files" v-if="files.length == 0">
                    <h3 class="h4 font-weight-light">{{ __('voyager::media.no_files_in_folder') }}</h3>
                </div>
            </div>
            <div id="right">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer border-top-0">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-pink" v-on:click="createFolder">{{ __('voyager::media.create_new_folder') }}
                        </button>
                    </div>
                </div>
            </div>
    ...
    <!-- Delete File Modal -->
    <div class="modal fade" :id="'confirm_delete_modal_'+this._uid" v-if="allowDelete">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                    <h4 class="modal-title"><i class="voyager-pink"></i> {{ __('voyager::generic.are_you_sure') }}</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <h5 class="folder_pink">
                        <i class="voyager-pink"></i> {{ __('voyager::media.delete_folder_question') }}
                    </h5>
                </div>
    ...
    <!-- Move Files Modal -->
    <div class="modal fade" :id="'move_files_modal_'+this._uid" v-if="allowMove">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                ...
                <div class="modal-footer border-top-0">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default" data-dismiss="modal">{{ __('voyager::generic.cancel') }}</button>
                        <button type="button" class="btn btn-pink" v-on:click="moveFiles">{{ __('voyager::generic.move') }}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Crop Image Modal -->
    <div class="modal fade" :id="'crop_modal_'+this._uid" v-if="allowCrop">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer border-top-0">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default" data-dismiss="modal">{{ __('voyager::generic.cancel') }}</button>
                        <button type="button" class="btn btn-pink" v-on:click="crop(false)">{{ __('voyager::media.crop') }}</button>
                        <button type="button" class="btn btn-pink" v-on:click="crop(true)">{{ __('voyager::media.crop_and_create') }}</button>
                    </div>
                </div>
            </div>
        </div>
