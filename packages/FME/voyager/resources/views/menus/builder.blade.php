            ...
            <div class="col-12">
                <div class="col-12">
                    ...
                    <div class="btn-group rounded-lg align-items-center">
                        <button class="btn btn-sm btn-default add_item"><i class="voyager-plus"></i> {{ __('voyager::menu_builder.new_menu_item') }}</button>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="col-12">
                    <div class="panel-heading">
                        <p class="panel-title text-muted">{{ __('voyager::menu_builder.drag_drop_info') }}</p>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h4 class="modal-title">{{ __('voyager::menu_builder.delete_item_question') }}</h4>
                ...
                <div class="modal-footer border-0">
                    <form 
                        action="{{ route('voyager.menus.item.destroy', ['menu' => $menu->id, 'id' => '__id']) }}"
                        id="delete_form"
                        method="POST"
                    >
                        @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                    <h4 id="m_hd_add" class="modal-title d-none">{{ __('voyager::menu_builder.create_new_item') }}</h4>
                    <h4 id="m_hd_edit" class="modal-title d-none">{{ __('voyager::menu_builder.edit_item') }}</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="{{ __('voyager::generic.close') }}">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-footer border-top-0">
                        <div class="btn-group">
                            <input type="submit" class="btn btn-pink delete-confirm__" value="{{ __('voyager::generic.update') }}">
    ...
    <script>
        $(document).ready(function () {
            ...
            var $m_modal       = $('#menu_item_modal'),
                $m_hd_add      = $('#m_hd_add').hide().removeClass('d-none'),
                $m_hd_edit     = $('#m_hd_edit').hide().removeClass('d-none'),
                $m_form        = $('#m_form'),
